...
class posts(db.Model):
    ...
    post = db.Column("post", db.String(1000))
    ...
    situation_t = db.Column("situation_t", db.Integer)

    def __init__(self, post, name, date, author_dep, ref_dep, context_t, situation_t):
        self.post = post
        self.name = name
        self.date = date
